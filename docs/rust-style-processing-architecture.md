...
- **Intelligent styles**: tier-aware processors (Basic/AudioAware/SpeakerAware) delegate to `create_tier_aware_intelligent_clip` / `create_tier_aware_split_clip` with YuNet + audio/speaker signals.
...
- **intelligent / intelligent_basic / intelligent_audio / intelligent_speaker**: tier-aware intelligent crop on a pre-cut segment; face/audio-driven framing; thumbnails generated.
