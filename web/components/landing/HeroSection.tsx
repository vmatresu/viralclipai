  ...
  return (
    <section className="min-h-screen flex items-center pt-24 pb-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[150%] h-[80%] bg-[radial-gradient(ellipse_80%_50%_at_50%_-20%,rgba(164,92,255,0.15),transparent)]" />
        <div className="absolute top-1/2 right-0 w-[60%] h-[60%] bg-[radial-gradient(ellipse_60%_40%_at_80%_60%,rgba(92,255,249,0.08),transparent)]" />
      </div>
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Button
                ...
                className="h-14 px-8 text-lg font-medium rounded-xl gap-2 glass-card border-white/10 hover:border-brand-400/30 hover:bg-brand-400/10"
                title="Coming soon"
              >
            ...
            {/* Social proof line */}
            <p className="text-sm text-muted-foreground pt-6 border-t border-white/5">
...
function AppMockup() {
  return (
    <div className="relative max-w-lg mx-auto lg:mx-0">
      {/* Glow effect */}
      <div className="absolute -inset-4 bg-gradient-to-r from-brand-400 to-brand-cyan rounded-3xl opacity-20 blur-3xl animate-glow-pulse" />

      <div className="glass-card rounded-3xl p-6 relative">
        {/* Viral badge */}
        <div className="absolute -top-3 right-6 flex items-center gap-1.5 bg-brand-cyan/10 border border-brand-cyan/30 px-3 py-1 rounded-full">
        ...
        <div className="flex gap-3 mb-4">
          ...
          <button className="btn-primary-gradient px-4 py-2 rounded-lg text-sm font-semibold whitespace-nowrap">
            Analyze Video
          </button>
        </div>
                ...
                <div
                  ...
                  className={`absolute top-1/2 -translate-y-1/2 w-2 h-2 rounded-full border-2 ${
                    i < 3
                      ...
                      : "bg-brand-darker border-muted-foreground"
                  }`}
                  style={{ left: `${pos}%` }}
                />
              ))}
        ...
        <div className="grid grid-cols-3 gap-3">
          <ClipCard
            label="Best hook"
            labelClass="bg-brand-400/20 text-brand-400"
            duration="0:32"
          />
          <ClipCard
          ...
          <ClipCard
            ...
            labelClass="bg-brand-cyan/20 text-brand-cyan"
            duration="0:45"
          />
        </div>
      </div>
...
function ClipCard({
  ...
  return (
    <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:-translate-y-1 transition-transform">
      <div className="aspect-[9/12] bg-gradient-to-br from-brand-400/10 to-brand-cyan/5 flex items-center justify-center relative">
        ...
        <span className="absolute bottom-2 right-2 bg-black/70 px-1.5 py-0.5 rounded text-xs font-medium">
          {duration}
        </span>
      </div>
