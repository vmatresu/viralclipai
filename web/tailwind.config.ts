  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Brand colors - purple to cyan gradient theme
        brand: {
          50: "#f5f0ff",
          100: "#ede5ff",
          200: "#ddd0ff",
          300: "#c4a8ff",
          400: "#a45cff", // Primary purple
          500: "#8b3dff",
          600: "#7c2df0",
          700: "#6a1fd4",
          800: "#5a1aab",
      ...
      animation: {
        ...
        "text-cycle": "text-cycle 0.5s cubic-bezier(0.16, 1, 0.3, 1)",
        "orb-float": "orb-float 20s ease-in-out infinite",
        "progress-scan": "progress-scan 3s ease-in-out infinite",
      },
      spacing: {
