...
import type { CachedClipsData } from "./types";
 ...
 */
export function getCachedClips(videoId: string): Promise<CachedClipsData | null> {
 ...
 */
export function setCachedClips(
  videoId: string,
 ...
 */
export function invalidateClipsCache(videoId: string): Promise<void> {
 ...
 */
export function invalidateClipsCacheMany(videoIds: string[]): Promise<void> {
 ...
 */
export function clearAllClipsCache(): Promise<void> {
