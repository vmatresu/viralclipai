    ...
    <div className="space-y-6">
      <section className="space-y-3">
        ...
        <p className="text-gray-300 max-w-2xl">
          Questions about pricing, onboarding your team, or feature requests?
      ...
      <section className="space-y-3">
        ...
        <p className="text-gray-300">
          We aim to respond within 1 business day for Free users and within a
          few business hours for Pro and Studio customers.
        </p>
      </section>
    </div>
  );
