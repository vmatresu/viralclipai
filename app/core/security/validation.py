...
def validate_style(style: str) -> str:
    ...
    # Match AVAILABLE_STYLES from app.core.clipper plus "all", "intelligent", "intelligent_split", and "original"
    ALLOWED_STYLES = {"split", "left_focus", "right_focus", "all", "intelligent", "intelligent_split", "original"}
